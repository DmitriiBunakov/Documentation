...
//!=============================================================================
//? /Signals/
//? signal - метод который использоваться может вместо подписок и обычного состояния. Ангуляр везде где используются сигналы - будет их помечать как "зависимость данного компонента" и помечать markForCheck при изменении, но не запускать перерисовку
