...
//? Проверка изменений запускается с самого верхнего уровня и вниз по дереву
//? если компоненты default стратегию имеют, то они будут перерисовываться на любую аснихронную операцию, обработчики, инпут параметры, асинхронные изменения пайпа. Также они будут запускать для дочерних компонентов changeDetection, если они не onPush, или не detach от дерева изменений.
