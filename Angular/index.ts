...
//? eсли onPush, то цикл будет запущен только при клике в этом компоненте или дочернем, изменении input параметров, а также при явной пометке на изменения
...
//? при встрече onPush стратегии, если цикл обнаружений был запущен снизу, до текущего компонента проверяемого, либо с него, то он будет проверен и перерисован, все компоненты ниже триггера, имеющие onPush не будут перерисованы и проверены
...
//!================================================================================================================================================
// TODO https://www.digitalocean.com/community/tutorials/angular-route-resolvers
...
//? 4) children - дочерние маршруты для данного маршрута, массив Route
...
//? Информация о роуте для данного компонента, который отображается
