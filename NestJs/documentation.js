...
//? Данный экземпляр внедряется в перехватчики и guard'ы, в данном обьекте содержится информация по контексту выполнения.
//? Какой обработчик будет вызван следующим, на каком контроллере сейчас выполнение, а также можно получить доступ к запросу, ответу, и типу запроса, это http, вебсокеты или микросервисы
...
//? В нест можно подключить любую библиотеку по работе с базой данных
...
//!================================================================================================================================================
//? Сначала отработает middleware, guards,