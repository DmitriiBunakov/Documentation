...
//!=============================================================================
//? share
//? делится со всеми подписчиками потоком, как только поток завершается, новый подписчик вызовет создаст новый поток, новый запрос грубо говоря, и если в этот момент кто то подпишется, он получит тот же поток (то есть заново не будет создан другой поток при подписке)
/*
...
//!=============================================================================
//? shareReplay
//? как share - только при подписке новые подписчики получат старые данные из буфера