...
//? 3) async - получение скрипта происходит асинхронно, а выполнение будет произведено сразу после скачивания, очередность выполнения не гарантируется
//? 4) defer - получение происходит асинхронно, но выполнение будет просиходить только после того, как страница будет загружена целиком
