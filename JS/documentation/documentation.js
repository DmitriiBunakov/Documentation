...
//? Лексическая область видимости создается во время написания кода(компиляции, но не работы), то есть лексическая область видимости это то, ГДЕ объявлено значение, а динамическая область - откуда была вызвана(в js нет динамической области видимости)
//? Почему функция f2 имеет доступ к a переменной? потому что лексически он
/*
function a() {
    function b() {
