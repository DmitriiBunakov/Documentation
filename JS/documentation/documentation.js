...
//? async/microTasks сразу после каждой задачи движок исполняет все задачи из очереди микрозадач перед тем, как выполнить следующую макрозадачу или отобразить изменения на странице, или сделать что-то ещё. Все микрозадачи завершаются до обработки каких-либо событий или рендеринга, или перехода к другой макрозадаче. Микрозадачи всегда беруться раньше всего остального из очереди, они имеют приоритет
//? queueMicroTask
//? requestanimationframe,а также отрисовка дальнейшая
//? painting/composition отрисовка, если она есть. Выполняются все задачи в очереди по рендеру страницы
//? timers
//? events
//? requestIdleCallback
