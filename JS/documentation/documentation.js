...
//?================================================================================================================================================
//? Scope/Область видимости/LexicalEnvironemt/Лексическое окружение/
...
//? сборщик удаляет обьеты те, на которые больше нет ссылок, даже если удаляемый обьект имеет ссылки на другие, он будет удален, потому что важны только ссылающиеся на него ссылки
/*
let user = {name: 'dima'};
...
//? перебор обьектов через for in.  key - ключи, a[key] - значения, проходит только по ПЕРЕЧИСЛЯЕМЫМ элементам, символы не берет
/*
