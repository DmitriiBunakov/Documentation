...
//? /passive/ - boolean(обработчик никогда не может быть отменен через preventDefault, некоторые события по дефолту идут уже с true, поэтому может не работать preventDefault)
