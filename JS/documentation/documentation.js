...
//? SameSite - cors - отправляются ли они с межсайтовыми запросами(в старых браузерах не работает)
...
//?=============================================================================
//? /Clickjacking/
//? При взаимодействии с интерфейсом пользователь нажимает на то, что он не видит и таким образом можно отослать данные не туда
