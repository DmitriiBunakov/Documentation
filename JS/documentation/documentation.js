...
//? Забаный факт, но сначала был создан JS в 1996 году, в 1997 году был принят стандарт ES, получается, что JS все таки батgit
...
//? Движки могут быть по разному реализуемы, в виде обычного интерпретатора, динамического компилятора.
...
//?         использовать тэг и писать код внутри него
/*
    <script>
        console.log(1);
    </script>
*/
//?         использовать js внутри обработчика событий на тэге
/*
    <a href="delete.php" onclick="return confirm('Вы уверены?'); return false;">Удалить</a>
*/
//?         вынести в отдельный файл и подключить с помощью тэге и src
/*
...
//? async - получение скрипта происходит асинхронно, а выполнение будет произведено сразу после скачивания, очередность выполнения не гарантируется
//? defer - получение происходит асинхронно, но выполнение будет просиходить только после того, как страница будет загружена целиком
