...
//? /Protocol/Протокол/
//? http/https - hyper text transfer protocol протоколы позволяющие обмениваться данными, то есть это единый подход к обмену данными в интернете
//? https использует защищенность SSL/TSL


//? /IP/DNS/
//? ip - уникальный id девайса в сети
//? dns - сущность отвечающая за преобразование человека-читаемого адреса в ip (строки преобразуются в ip)
